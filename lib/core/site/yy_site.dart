  ...
  Future<dynamic> _liveStreamObj({required LiveRoom detail, required String qn}) async {
    return decodeJson(await HttpClient.instance.postJson(
      ...
      data: {
        ...
        'client_attribute': {'client': 'web', 'model': 'web0', 'os': 'chrome', 'client_type': 8, 'h265': 0},
        'avp_parameter': {'version': 1, 'client_type': 8, 'service_type': 0, 'gear': int.tryParse(qn) ?? 1, 'ssl': 1, 'stream_format': 0},
      },
      header: headers,
    ));
  }
